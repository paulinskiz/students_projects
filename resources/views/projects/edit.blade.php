            ...
            <div class="col-4">
                <form action="{{ route('projects.update', $project->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="groups" value="{{ $project->groups }}" class="form-control">
                        @error('groups')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="students_group" value="{{ $project->students_group }}" class="form-control">
